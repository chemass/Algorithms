...
public class DequeRollingArrayTest {

	@Test
	public final void testDeque() {
		DequeRollingArray<String> dq = new DequeRollingArray<String>();
		dq = null;
	}
	...
	public final void testHUUUUUUUUUUUUGE() {
		...
		DequeRollingArray<Integer> dq = new DequeRollingArray<Integer>();
	...
	public final void testIterator() {
		...
		dq = new DequeRollingArray<Integer>();
		for (i = 1; i <= 8; i++) {
			dq.addFirst(i);
		}
